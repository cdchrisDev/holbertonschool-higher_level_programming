# This is Python - More data structures and dictionary (5/25)
### Resources
...
**SOLVED**
```
"""a func that returns diff element"""


def only_diff_elements(set_1, set_2):
    """returns the diff elements"""
...
def roman_to_int(roman_string):
    ...
    for item in range(item, len(roman)):
        if item < len(roman) - 1\
            and roman_dictionary[roman[item]] <\
